...
directory_name = "dataset/valid_fixed/"  # Updated to use valid_fixed

# Read the labels file from the example_download_script directory
data = pd.read_csv("example_download_script/valid_labels.csv")

print(f"Starting download of {len(data)} validation volumes from valid_fixed folder...")
